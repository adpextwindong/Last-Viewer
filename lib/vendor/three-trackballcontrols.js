...
class TrackballControls extends THREE.EventDispatcher {
    constructor(object, domElement, rafHandler){
        ...
        let TrackballControlsScope = this;
        //Bind event handlers and use correct trackballscope;
        //

        //TODO move the event handler setting into a function that is called during init
        //That way the TrackballControl scope can be done inside the class and not globally in this file incase multiple canvases are in the window w/ seperate controls
        /**
    ...
    //TODO we need a TrackBall scope variable for these event handlers.
        ...
        this.mousewheel = function( event ) {
            ...
            switch ( event.deltaMode ) {
                ...
                case 2:
                    // Zoom in pages
                    TrackballControlsScope.zoomStart.y -= event.deltaY * 0.025;
                    break;

                case 1:
                    // Zoom in lines
                    TrackballControlsScope.zoomStart.y -= event.deltaY * 0.01;
                    break;

                default:
                    // undefined, 0, assume pixels
                    TrackballControlsScope.zoomStart.y -= event.deltaY * 0.00025;
                    break;
