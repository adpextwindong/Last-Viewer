...
/* eslint no-redeclare: 0 */
   ...
   *
   * THIS FILE WAS ORIGINALLY MIT LICENSED BY MRDOOB
   * THIS HAVE BEEN MODIFIED BY GEORGE TAKUMI CRARY TO WORK FOR THE LAST VIEWER.
   * It used to be an old style class that took in THREE.
   * I'm trying to port this to an ESModule
   * It supports OBJ files generated by I-Ware Laboratory's File Converter
   */
